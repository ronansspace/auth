...
$sql = "call get_brokerpl('$startDate','$endDate')";
...
while($fetch = $result->fetch_array()) {
    $output[] = array (
        $fetch["Contract"],$fetch["OrderID"],$fetch["Broker"],$fetch["TradeDate"],$fetch["Pair"],$fetch["GrossProfit"],$fetch["BrokerCost"],$fetch["VenueCost"],$fetch["TotalCost"],$fetch["NetProfit"]
    );
