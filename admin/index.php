    ...
    <div class="container-fluid">
        ...
        <div style="width:90%;margin:0 auto;padding-top:15px;">
            ...
            <header>
                ...
                <h3>
                    <label class="label label-success" style="font-weight:100; margin-right:10px;">Trader
                        ID: <?php echo $_SESSION['auth_id']; ?></label>
                    <label class="label label-info" style="font-weight:100; margin-right:10px;">Trader
                        : <?= ucfirst($client); ?></label>
            ...
            <div class="controls-div">
                ...
                <div class="btn-group" data-toggle="buttons">
                    <input type="button" class="btn btn-primary btn-sm record_new" value="New Trade"
                           style="margin-right:0px;">
                    <input type="button" class="btn btn-primary btn-sm record_copy" value="Copy Trade"
                           style="margin-right:0px;">
                    <input type="button" class="btn btn-danger btn-sm record_delete" value="Delete Trade"
                           style="margin-right:5px;">
                </div>

                <div class="btn-group" data-toggle="buttons">
                    <input type="button" class="btn btn-info btn-sm email_rbs" value="Email RBS" style="">
                    <input type="button" class="btn btn-info btn-sm email_client" value="Email Client"
                           style="margin-right:0px;">
                    <input type="button" class="btn btn-info btn-sm view_csv" value="View CSV"
                           style="margin-right:5px;">
                </div>
            ...
            <div id="optionexpiries" style="width:100%;float:left;display:inline;">
                ...
                <table id="jsontable_expiries" class="display table table-hover table-striped table-bordered nowrap"
            ...
            <div id="fixdetail" style="width:100%;float:left;display:inline;">
                ...
                <table id="jsontable_fixexecs" class="display table table-hover table-striped table-bordered nowrap"
                       cellspacing="0" width="100%">
                    <thead>
                    <tr>
                        <th>Transact Time</th>
...
?>
    ...
    <script>
        ...
        $(document).on("dblclick", ".record_row", function () {
            ...
            $('#back').load('newtrade_new.php?id=' + did, function (responseTxt, statusTxt, xhr) {
        ...
        $(document).on("click", ".record_copy", function () {
            ...
            if (checkedVals.join(",") == "") {
                ...
                if ($('.check_box:checkbox:checked').length > 1) {
                    ...
                    $('#back').load('newtrade_new.php?id=' + checkedVals + '&only_copy=yes', function (responseTxt, statusTxt, xhr) {
                        if (statusTxt == 'success') {
                            $('#back').show();
                            ch_contract();
                            $('.container').show();
        ...
        function getexpiries() {
            ...
            $('#jsontable_expiries').dataTable().fnDestroy();

            var oTable = $('#jsontable_expiries').dataTable({
                "iDisplayLength": 25,
                "processing": true,
                "scrollX": true,
            ...
            $.ajax({
                ...
                url: 'process_expiries.php?method=fetchdata&theid=' + all_val + '&stdate=' + stDate + '&endate=' + enDate + " ",
                dataType: 'json',
                success: function (s) {
